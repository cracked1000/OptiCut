...
async function main() {
  ...
  // ✅ FIXED: previously this also granted LAB_ROLE to the deployer as a
  // bootstrap "Genesis Lab". That made the NGJA admin wallet show up in the
  // admin panel's lab list and be revocable as a lab — confusing, even
  // though revoking LAB_ROLE never touched NGJA_ADMIN_ROLE. Grant a real
  // lab's LAB_ROLE from the admin panel after deployment instead.
